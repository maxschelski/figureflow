...
***FOR MAC AND LINUX: INSTALLATION FIXED!*** <br/>
The environment.yml was fixed by Thomas Cheng (https://github.com/nhcheng) and now only includes necessary dependencies.
